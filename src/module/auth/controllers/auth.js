...
exports.getAllUsers = async (req, res) => {
  try {
    const user = await User.find({role: 'user'}).select('-otp -confirmEmailToken -isEmailConfirmed -twoFactorEnable -tokens');
    res.status(200).json({
      success: true,
      data: user,
    });
...
exports.updateUserProfile = async (req, res, next) => {
  try {
    ...
    user.postalZip = req.body.postalZip || user.postalZip;
    user.telephone = req.body.telephone || user.telephone;
    user.extension = req.body.extension || user.extension;
    user.fax = req.body.fax || user.fax;
    user.cellphone = req.body.cellphone || user.cellphone;
    user.ownerContact = req.body.ownerContact !== undefined ? req.body.ownerContact : user.ownerContact;
    user.primaryContact = req.body.primaryContact !== undefined ? req.body.primaryContact : user.primaryContact;
    user.accountingContact = req.body.accountingContact !== undefined ? req.body.accountingContact : user.accountingContact;
